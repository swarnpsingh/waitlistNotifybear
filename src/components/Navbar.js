      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-7 h-7 sm:w-8 sm:h-8">
            <img src={mascot} alt="notifybear mascot" className="w-full h-full object-contain block" />
            <img
              src={hat}
              alt="christmas hat"
              className="absolute -top-3 -left-2 w-5 h-5 sm:w-6 sm:h-6 pointer-events-none transform rotate-12"
