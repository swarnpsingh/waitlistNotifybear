  ...
  return (
    <section id="why" className="relative bg-cream">
      <div className="mx-auto max-w-6xl px-6 pb-20 pt-10 sm:pt-14">
        ...
        >
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-focus">Why this exists</p>
          <h2
          ...
          >
            When your work runs on messages, both options are bad.
          </h2>
          <p className="text-[0.95rem] leading-relaxed text-ink/55">
            If a client, a patient, a trade, or an on-call page can land on your phone at any hour,
            you can't miss the wrong message. But you also can't do real work while being tapped on
            the shoulder every four minutes. Most people pick one of these and quietly pay for it.
          </p>
        </motion.div>

        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2">
          {TRAPS.map(({ icon: Icon, title, copy }, i) => (
            <motion.div
              key={title}
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="rounded-3xl bg-white p-7 shadow-[0_2px_8px_rgba(22,41,79,0.04),0_12px_32px_rgba(22,41,79,0.06)]"
            >
      ...
      <div className="px-6 pb-24">
        ...
        >
          ...
          <div className="relative mx-auto max-w-[760px] text-center">
            <span
              aria-hidden
              className="mx-auto mb-6 block h-[3px] w-12 rounded-full bg-bell"
            />
            <p
